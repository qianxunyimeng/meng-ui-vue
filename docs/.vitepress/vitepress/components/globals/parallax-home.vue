...
<template>
  ...
  <footer class="footer">
    <div class="footer-main">
      <h4>{{ homeLang['10'] }}</h4>
      <a
        href="https://github.com/qianxunyimeng/meng-ui-vue"
      ...
      <a
        href="https://github.com/qianxunyimeng/meng-ui-vue/releases"
        class="footer-main-link"
        target="_blank"
      >
        {{ homeLang['12'] }}
    ...
    <div class="footer-main">
      ...
      <a
        href="https://github.com/qianxunyimeng/meng-ui-vueissues"
        class="footer-main-link"
        target="_blank"
      >
        {{ homeLang['16'] }}
