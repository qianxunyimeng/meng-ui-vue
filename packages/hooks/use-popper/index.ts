...
import { ClickOutside } from '@meng-ui-vue/directives'
import {
  generateId,
  isHTMLElement,
  isString,
  refAttacher,
} from '@meng-ui-vue/utils/util'
import { getFirstValidNode } from '@meng-ui-vue/utils/vnode'
import { stop } from '@meng-ui-vue/utils/dom'
import PopupManager from '@meng-ui-vue/utils/popup-manager'
...
import type { RefElement, Nullable } from '@meng-ui-vue/utils/types'
...
export const usePopperHook = () => {
  ...
  const popperId = `mx-popper-${generateId()}`
